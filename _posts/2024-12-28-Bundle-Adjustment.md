...
ở hiện tại ra một số bài toán trong không gian có tồn tại nhiễu như cây cối, các kiến trúc có tính đối xứng, việc matching trở thành rất khó. Quay lại với bài toán chúng ta bàn luận \
ta cần phải giả thiết rằng các điểm chung ta tìm được là đúng. Các điểm chung trong ảnh được gọi là 2D correspondences, và chúng được viết dưới dạng sau:
$$
